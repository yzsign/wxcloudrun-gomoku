...
public final class CosmeticCategory {
    ...
    /**
     * 对局头像旁技能槽 Q（短剑），item_id 与消耗品 kind 一致为 {@code dagger}；
     * 卸下时删除槽位行（客户端 POST equip itemId={@code off}）。
     */
    public static final String BOARD_SKILL = "BOARD_SKILL";
    /**
     * 对局头像旁技能槽 W（爱心），item_id 与消耗品 kind 一致为 {@code love}。
     */
    public static final String BOARD_SKILL_LOVE = "BOARD_SKILL_LOVE";
